...
public class RecyclerVewAdapter extends RecyclerView.Adapter<RecyclerVewAdapter.MyViewHolder>{
    ...
    Context mContext;
    List<Vocabulary> mData;

    Dialog myDialog;



    public RecyclerVewAdapter(Context mContext, List<Vocabulary> mData) {
        ...
        vHolder.item_vocabulary.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mData.get(vHolder.getAdapterPosition()).getName()=="Lesson 01"){
                    Intent intent = new Intent(mContext, N5ViewIntentVoca.class);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        private LinearLayout item_vocabulary;
